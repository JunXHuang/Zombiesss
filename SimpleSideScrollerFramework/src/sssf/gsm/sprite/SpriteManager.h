...
private:
	...
	//list<Bot*> bots;
	// NOTE THAT WE ARE USING A BINARY TREE, NOT A QUAD TREE
	// THIS IS BECAUSE OUR LEVELS WILL BE SHORT AND WIDE (THINK SUPER MARIO)
	struct Btree {
		list<Bot*> bots;
		Btree* next[2];
	};
...
public:
	...
	void				addBot(Game* game, Bot *botToAdd);
